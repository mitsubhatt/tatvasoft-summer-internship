...
namespace Mission.Repositories.Repositories
{
    public class LoginRepository(MissionDbContext missionDbContext) : ILoginRepository
    {
        ...
        {
            var isExist = _missionDbContext.Users.Where(x => x.EmailAddress == Model.EmailAddress).FirstOrDefault();
        ...
        public string UpdateUser(UserDetails model, string webRootPath)
        {
            ...
            var existingUser = _missionDbContext.Users.Where(x => x.Id == model.Id).FirstOrDefault() ?? throw new Exception("not exist");
