...
SELECT customer_id FROM customer WHERE first_name = 'Bansi'
...
SELECT first_name, last_name FROM customer WHERE first_name LIKE '%EN%'; -- case-sensitive
SELECT first_name, last_name FROM customer WHERE first_name ILIKE '%EN%'; -- case-insensitive
